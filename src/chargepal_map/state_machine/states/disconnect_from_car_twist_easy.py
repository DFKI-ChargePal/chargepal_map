...
class MovePlugToBattery(State):
    ...
    def __init__(self, config: dict[str, Any], pilot: Pilot):
        ...
        self.cfg = StateConfig(type(self), config=config)
        self.uc = UserClient(self.cfg.data['step_by_user'])
        State.__init__(self, outcomes=[out.Common.stop, out.DisconnectFromCarTwist.plug_in_bat_post_obs])
...
class MovePlugToBatteryPreConnect(State):
    ...
    def __init__(self, config: dict[str, Any], pilot: Pilot):
        ...
        self.cfg = StateConfig(type(self), config=config)
        self.uc = UserClient(self.cfg.data['step_by_user'])
        State.__init__(self, outcomes=[out.Common.stop, out.DisconnectFromCarTwist.plug_in_bat_pre_connect])
...
class InsertPlugToBattery(State):
    ...
    def __init__(self, config: dict[str, Any], pilot: Pilot):
        ...
        self.cfg = StateConfig(type(self), config=config)
        self.uc = UserClient(self.cfg.data['step_by_user'])
        State.__init__(self, outcomes=[out.Common.stop, out.DisconnectFromCarTwist.plug_in_bat_connect])
