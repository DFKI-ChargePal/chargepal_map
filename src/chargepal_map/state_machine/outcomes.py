...
err_obs_plug_retry = 'error_obs_plug_retry'
err_obs_plug_recover = 'error_obs_plug_recover'
err_obs_socket_retry = 'error_obs_socket_retry'
err_obs_socket_recover = 'error_obs_socket_recover'
...
socket_scene_obs = 'socket_scene_observed'
