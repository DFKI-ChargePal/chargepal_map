...
class DisconnectFromCarOutcomes:
    ...
    plug_in_battery_pre_connect = 'plug_in_battery_pre_connection'
    plug_in_battery_connect = 'plug_in_battery_connection'
    arm_in_battery_post_connect = 'arm_in_battery_post_connection'
    arm_in_driving_pose = 'arm_in_driving_pose'
